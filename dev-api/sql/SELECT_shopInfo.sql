SELECT
    shop_cd,shop_name,shop_location,shop_info,shop_tel,shop_img,shop_open,shop_close,staff_list,menu_list,ratings_ave,shop_serial,location_lat,location_lng,
